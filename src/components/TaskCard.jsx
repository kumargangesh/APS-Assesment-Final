      ...
      <Card.Body className="d-flex flex-column">
        <div className="d-flex justify-content-between align-items-start mb-2">
          <Form.Check
            ...
            label={
              <span className={isCompleted ? 'text-decoration-line-through text-custom-muted fw-semibold' : 'fw-semibold'}>
                {task.title}
              </span>
            }
          />
        ...
        <div className="d-flex justify-content-between align-items-center mt-auto pt-2 border-top">
          <div className="small text-custom-muted d-flex align-items-center gap-2">
...
//             <span className="badge bg-outline-secondary me-1" style={{
//               color : "black"
//             }}>{task.category}</span>
//             {task.dueDate && (
//               <span><i className="bi bi-calendar3 me-1"></i>{new Date(task.dueDate).toLocaleDateString()}</span>
